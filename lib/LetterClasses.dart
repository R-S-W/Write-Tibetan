...
class Letter {
  ...
  //The strokes of the letter are all in 1 string, the pathString (from pathList, we got pathString.)
  ...
  Letter(String dataLine){
    ...
    this.strokeVariations.forEach( (str) => this.numStrokesList.add(str.split(" ").length) );
